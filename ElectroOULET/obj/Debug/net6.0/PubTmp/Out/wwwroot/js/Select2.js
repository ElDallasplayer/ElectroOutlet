...
!function (a) {
    ...
    var b = function () {
        ...
        return function () {
            ...
            b.define("select2/i18n/en", [], function (a) {
                return {
                    ...
                    noResults: function () {
                        $('.select2-results__options').html('<div id="agregarButtonSelect" style="margin-left:15%;" class="btn btn-secondary">Agregar codigo de producto</div>');
                        UpdateButtonSelect();
